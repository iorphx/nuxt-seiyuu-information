  ...
  <div>
    <base-header class="pb-6" type="">
      <div class="row align-items-center py-4">
        <div class="col-12">
          <h6 class="h2 d-inline-block mb-0">굿즈 정보 추가</h6>
          <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
            <ol class="breadcrumb breadcrumb-links">
              ...
              <li v-if="project" class="breadcrumb-item"><nuxt-link :to="`/goods/${project.value}`">{{project.label}} 굿즈</nuxt-link></li>
              <li class="breadcrumb-item active" aria-current="page">굿즈 정보 추가</li>
            </ol>
          </nav>
        </div>
      </div>
            ...
            <div class="row justify-content-center">
              <div class="col-lg-5 col-md-12 mb-3 mb-lg-0">
                <img src="https://dummyimage.com/450x450/bbbbbb/ffffff&text=no+image"
                     ...
                     style="width: 450px;" v-if="!imgPreview">
                <img :src="imgPreview"
                     class="img-center img-fluid shadow shadow-lg--hover mb-2"
  ...
  export default {
    ...
    methods: {
      ...
      submitData() {
        ...
        this.$axios.$post('/api/goods', formData, {headers: {'Content-Type': 'multipart/form-data'}})
          .then(data => {
            this.$notify({type: 'success', message: '정보를 성공적으로 생성했습니다', timeout: 3000})
