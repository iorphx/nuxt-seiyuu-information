  ...
  <div>
    <base-header class="pb-6" type="">
      <div class="row align-items-center py-4">
        <div class="col-12">
          <h6 class="h2 d-inline-block mb-0">성우 정보 추가</h6>
          <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
            <ol class="breadcrumb breadcrumb-links">
              ...
              <li class="breadcrumb-item active" aria-current="page">성우 정보 추가</li>
            </ol>
          </nav>
        </div>
      </div>
          ...
          <card>
            <div class="row justify-content-center">
              <div class="col-lg-3 order-lg-2">
                <img src="https://dummyimage.com/450x450/bbbbbb/ffffff&text=no+image" class="img-center rounded-circle" style="width:200px;" v-if="!imgPreview ">
  ...
  export default {
    ...
    methods: {
      ...
      submitData() {
        ...
        this.$axios.$post('/api/seiyuu', formData, {headers: {'Content-Type': 'multipart/form-data'}})
          .then(data => {
